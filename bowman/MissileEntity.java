...
//    }
    ...
    public void render(Graphics2D g2d) {
        ...
        xPoints[0] = (int) x - flip*width / 2;   yPoints[0] = (int) y;
        xPoints[1] = (int) x - flip*width + flip*6;   yPoints[1] = (int) y;
        xPoints[2] = (int) x - flip*width + flip*4;   yPoints[2] = (int) y - 2;
        xPoints[3] = (int) x - flip*width;       yPoints[3] = (int) y - 2;
        xPoints[4] = (int) x - flip*width + flip*2;   yPoints[4] = (int) y;
        xPoints[5] = (int) x - flip*width + flip*6;   yPoints[5] = (int) y;
        xPoints[6] = (int) x - flip*width + flip*4;   yPoints[6] = (int) y + 2;
        xPoints[7] = (int) x - flip*width;       yPoints[7] = (int) y + 2;
        xPoints[8] = (int) x - flip*width + flip*2;   yPoints[8] = (int) y;
        xPoints[9] = (int) x;               yPoints[9] = (int) y;
